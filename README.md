...
| [dev-plan](./dev-plan/) | `/dev-plan` | 単体 Issue でも複数 Issue でも使える。依存関係を分析し、Wave 構造の並列開発プロンプトを生成（例: `/dev-plan #5` `/dev-plan #3-10`） |
| [gtr-workflow](./gtr-workflow/) | `/gtr-workflow` | git worktree で隔離環境を作り並列開発 |
